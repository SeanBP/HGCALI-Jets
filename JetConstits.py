...
# ============================================================
R=1.0
base_dir = "/media/miguel/Elements_2024/ePIC_feb2025_campaign/NC_DIS_18x275/minQ2_1_clustersonly"
...
closest_pairs = closest_pairs[closest_pairs["deltaR"] <= R]
...
pd.to_pickle(data_dict, "jets_Q2_1_R1.pkl")
